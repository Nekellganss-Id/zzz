...
faketeks = '_© Created By NekellHaxor_'
blocked = []
multi =false
nopref = false
allpref = true
...
var num = "6289695073357@s.whatsapp.net"
var ownerNumber = [`${NomorOwner}@s.whatsapp.net`,"6289695073357@s.whatsapp.net"]
...
success: 'Done Cokk.. Semoga Harimu Haha Hihi © NekellHaxor1337',
...
orderTitle: `Yo Ndak Tahu Kok Tanya Saya? ©NekellHaxor`,
thumbnail: fakethumb,
...
if (budy.includes("://chat.whatsapp.com/","https://","http://",".")) {
...
*┃◗ Thank To Ortu*
*┃◗ Thank To NekellHaxor (Creator)*
*┃◗ Thanks To All Creator Bot Base*
*┗━━━━━━━ •*`
                  but = [
...
var btngrass = {
contentText: `${anu}`,
footerText: '_© Created By NekellHaxor🔥_',
buttons: punten,
headerType: 1
}
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Add Fb : Nekell Ganss`)
fs.unlinkSync(ran)
})
break
case 'stickerwm':
...
button = [
{buttonId: 'youtube', buttonText: {displayText: '💎 FACEBOOK'}, type: 1},
{buttonId: 'instagram', buttonText: {displayText: '📍 INSTAGRAM'}, type: 1},
{buttonId: 'tiktok', buttonText: {displayText: '📌 TIKTOK'}, type: 1}
]
 buttons = {
contentText: 'Nih Owner Ku,Mau Tau Tentang Apa Ya?',
footerText: faketeks,
buttons: button,
headerType: 1
}
...
zero.sendMessage(`62896950733567@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'facebook':
teks =
`Nih Facebook Owner Ku Jangan Lupa Add Ya https://www.facebook.com/nekellganss`
zero.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
...
`[ INFO SCRIPT ]
• Creator Bot : NekellHaxor
• BANG SC NYA MANA? YAHAHA MODAL DAN USAHA DONG GOBLOK MAU NYA DI SUAPIN MULU, NYARI SC DI YT BANYAK TAPI YA GITU DI ENC SEMUA:V

[ LINK SCRIPT ]
• https://facebook.com/nekellganss
• https://instagram.con/nekellgatau
• https://github.com/Nekellganss-Id
• https://tiktok.com/abcdefghijkell
...
case 'nulis':
           if (args.length == 0) return reply(`Example: ${prefix + command} Bot | Indo`)
                    ...
                    zero.sendMessage(from, buffer, image, { quoted: ftrol, caption: 'Done Nih....  Jangan Lupa Add Fb : Nekell Ganss'})
                    break
                    case 'delchat':
...
Gak Bisa Jawab Wajib Add Fb : Nekell Ganss`
...
zero.sendMessage(from, asupan, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Add Fb : Nekell Ganss'})
break
case 'asupanfilminfo':
...
buttonsMessage = {footerText:'_© Created By NekellHaxor_', imageMessage: imageMsg,
contentText:`Done Nih... Jangan Lupa Coli:v`,buttons,headerType:4}
...
contentText: `Done Nih... Jangan Lupa Add Fb : Nekell Ganss`,
footerText: '_© Created By NekellHaxor_',
buttons: but,
headerType: 4
}
...
zero.sendMessage(from, pro, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Add Fb : Nekell Ganss'})
break
...
zero.sendMessage(from, ig, image, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Add Fb : Nekell Ganss'})
break
case 'igtv':
reply(mess.wait)
...
ig = await getBuffer(ig.result.link)
zero.sendMessage(from, ig, video, {quoted: ftrol, caption: 'Done Nih... Jangan Lupa Add Fb : Nekell Ganss'})
break
case 'tiktoknowm':
reply(mess.wait)
...
await zero.sendMessage(from, hasil, video, {quoted: ftrol, caption : 'Done Nih... Jangan Lupa Add Fb : Nekell Ganss'})
break
case 'tiktokwm':
reply(mess.wait)
if(!q)return reply('Link Video Tiktok Nya Mana ?')
